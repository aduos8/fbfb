...
import { ButtonProps, btnVariants } from "@/components/ui/button";
...
const PaginationLink = ({ className, isActive, size = "icon", ...props }: PaginationLinkProps) => (
  <a aria-current={isActive ? "page" : undefined} className={cn(btnVariants({ variant: isActive ? "outline" : "ghost", size }), className)} {...props} />
);
